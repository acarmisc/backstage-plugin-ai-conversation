...
import { CHAT_SKILL_ANNOTATION_PREFIX, SkillSummary } from './types';
 ...
 * frontmatter on a skill SKILL.md is documentary only (name/description);
...
export function entityToSkillSummary(entity: Entity): SkillSummary {
  return {
    id: entityRef(entity),
