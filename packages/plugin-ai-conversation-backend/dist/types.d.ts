...
export declare const CHAT_SKILL_TYPE = "chat-skill";
/** Annotation namespace for skill-specific fields on a catalog entity. */
export declare const CHAT_SKILL_ANNOTATION_PREFIX = "chat-skill.acarmisc.org";
/** Backwards compatibility: old persona type/annotation names. */
export declare const CHAT_PERSONA_TYPE = "chat-skill";
export declare const CHAT_PERSONA_ANNOTATION_PREFIX = "chat-skill.acarmisc.org";
/**
