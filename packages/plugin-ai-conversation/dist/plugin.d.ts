...
export declare const aiConversationPlugin: import("@backstage/frontend-plugin-api").OverridableFrontendPlugin<{}, {}, {
    "api:ai-conversation": import("@backstage/frontend-plugin-api").OverridableExtensionDefinition<{
        kind: "api";
        name: undefined;
        config: {};
        configInput: {};
    ...
    "page:ai-conversation": import("@backstage/frontend-plugin-api").OverridableExtensionDefinition<{
        kind: "page";
        name: undefined;
        config: {
    ...
    "page:ai-conversation/analytics": import("@backstage/frontend-plugin-api").OverridableExtensionDefinition<{
        kind: "page";
        name: "analytics";
        config: {
            path: string | undefined;
